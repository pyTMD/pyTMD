...
UPDATE HISTORY:
    Updated 09/2026: added functions to predict gravitational perturbations
        induced by ocean tides via spherical harmonic expansion
...
def time_series(
    ...
    **kwargs,
    ...
    :cite:p:`Petit:2010tp,Ray:1989wf`
