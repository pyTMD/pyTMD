...
* ``docs``: split Love numbers to new background section `(#607) <https://github.com/pyTMD/pyTMD/pull/607>`_
* ``docs``: expand on troubleshooting `(#607) <https://github.com/pyTMD/pyTMD/pull/607>`_
* ``docs``: expand references and citations `(#607) <https://github.com/pyTMD/pyTMD/pull/607>`_
* ``docs``: add nutation angles plot `(#607) <https://github.com/pyTMD/pyTMD/pull/607>`_
* ``docs``: add hover text to some terms in the glossary `(#607) <https://github.com/pyTMD/pyTMD/pull/607>`_
