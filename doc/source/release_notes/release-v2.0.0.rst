...
- ``refactor``: placed interpolation routines into new module (`#141 <https://github.com/pyTMD/pyTMD/pull/141>`_)
- ``refactor``: move ``model`` class to ``io``
- ``feat``: add constants class for ellipsoidal and gravitational parameters (`#135 <https://github.com/pyTMD/pyTMD/pull/135>`_)
- ``feat``: functions to read and interpolate from all constituents (`#137 <https://github.com/pyTMD/pyTMD/pull/137>`_)
- ``feat``: new functions to output ATLAS, FES and GOT netCDF4 files (`#139 <https://github.com/pyTMD/pyTMD/pull/139>`_)
...
.. __: https://github.com/pyTMD/pyTMD/releases/tag/2.0.0
