...
The Earth's rotation axis is inclined at an angle of 23.5 degrees to the celestial pole, and precesses about the celestial pole approximately once every 26,000 years :cite:p:`Dehant:2015vb,Kantha:2000vo`.
...
.. plot:: ./background/precession-nutation.py
    :caption: Precession and Nutation of the Earth's Rotation Axis :cite:p:`Dehant:2015vb`
    :align: center
